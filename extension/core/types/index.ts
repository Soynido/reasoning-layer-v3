...
// ✅ Mapping entre CaptureEvent et Evidence
export function mapCaptureEventToEvidence(event: CaptureEvent): Evidence {
    ...
    // Mapping pour git_branch
    if (event.type === 'git_branch') {
        return {
            id: event.id,
            type: 'git_branch',
            source: event.source,
